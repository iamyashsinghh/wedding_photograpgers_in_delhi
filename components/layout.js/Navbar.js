            ...
            <div className="menu-info side-menu">
                ...
                <ul className="menu-list">
                    <li className="menu-item">
                        <Link href="http://weddingbanquets.in/blog" className="menu-item" target='_blank'>Blog</Link>
                    </li>
                    <li className="menu-item">
                        <Link href={`http://weddingbanquets.in/business`} className="menu-item" target='_blank'>List Your Business</Link>
                    </li>
                    {
                        loggedUser ? <Link href={`https://weddingbanquets.in/user/profile`} className="menu-item" target='_blank'><FaUser /></Link> : (
                            <li className="menu-item">
                                <Link href={`https://weddingbanquets.in/user/signin`} className="menu-item" target='_blank'>Sign in</Link>
                            </li>
                        )
                    }
                </ul>
